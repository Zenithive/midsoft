  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="flex items-center gap-2">
        <Button onClick={() => setShowCreateCustomer(true)}>Add New Customer</Button>
        {showCreateCustomer && <Button variant="outline" onClick={() => setShowCreateCustomer(false)}>Close</Button>}
      </div>
